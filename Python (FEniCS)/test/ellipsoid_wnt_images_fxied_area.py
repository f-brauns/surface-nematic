...
beta=1
raw_density=46#161#139#87#207
Run_n_wnt=1
Run_n_z=1

wnt_strength_array=np.linspace(0.05,1,Run_n_wnt)
#z0_array=np.linspace(0.8*R,0.9*R,Run_n_z)
ratio_array=np.linspace(1.1,2.5,Run_n_z)
...
file_loc=path_to_cache+'/s_afa'#+'/wnt_strength_'+str(np.round(np.max(wnt_strength_array)))+'-'+str(np.round(np.min(wnt_strength_array)))+'_Range_'+str(np.round(np.max(z0_array)))+'-'+str(np.round(np.min(z0_array)))
...
for j in range(0,Run_n_z):
    ...
    for i in range(0,Run_n_wnt):
        ...
        #Func_space.add_noise(0.5,seed=2021)
        ...
        #vs.save_data(data=Dir_profile,data_file_name=file_loc+'/director_'+str(N*dt)+'.txt',append_=False)
        vs.save_data(data=mesh_cood,data_file_name=file_loc+'/mesh_'+str(N*dt)+'.txt',append_=False)
        ...
        while condition_check<Target_num:
            ...
            if (N % plot_density)==0:
               ...
               # vs.plot_wnt_range(plot_index=1,z0=z0,alpha=alpha,R=R,title='Wnt Strength: '+str(wnt_strength),color='red',view_elev=view_elev, view_azim=view_azim,sub_fig=False,alpha_p=0.9)
                ...
                vs.plot_func_surface(field_cood=S_order, Ct_id=0,plot_index=1,view_elev=view_elev, view_azim=view_azim,title='Nematic on Sphere: Back',color_range=[0,1],set_range=True,bg_off=True,cbar=False,alpha_c=0.3,marker_size=marker_sizea)
                vs.save_fig(file_loc+'/a',plot_index, 500,name=str(index_num), transparent=True)
                if N==0:
                    append_=True
                else:
                    append_=False
               # vs.save_data(data=Dir_profile,data_file_name=file_loc+'/director_'+str(N*dt)+'.txt',append_=append_)
                cha_=vs.chirality(_director=Dir_profile,Ct_id=2,middle_width=0.05)
                print(cha_)
                cha_arry.append(cha_)
                vs=Visualization(mesh_cood,mesh_loc,Dir_mesh,R=R,row_num=1,column_num=1,w=10,h=10)
             #   vs.plot_wnt_range(plot_index=1,z0=z0,alpha=alpha,R=R,title='Wnt Strength: '+str(wnt_strength),color='red',view_elev=view_elev, view_azim=view_azim,sub_fig=False,alpha_p=0.2)
               ...
               # vs.plot_wnt_range(plot_index=1,z0=z0,alpha=alpha,R=R,title='Wnt Strength: '+str(wnt_strength),color='red',view_elev=view_elev, view_azim=view_azim+azim_change,sub_fig=False,alpha_p=0.9)
                ...
                vs.plot_func_surface(field_cood=S_order, Ct_id=0,plot_index=1,view_elev=view_elev, view_azim=view_azim+azim_change,title='Nematic on Sphere: Front',color_range=[0,1],set_range=True,bg_off=True,cbar=False,alpha_c=0.3,marker_size=marker_sizea)
              ...
              #  vs.plot_wnt_range(plot_index=1,z0=z0,alpha=alpha,R=R,title='Wnt Strength: '+str(wnt_strength),color='red',view_elev=view_elev+elev_chage, view_azim=view_azim,sub_fig=False,alpha_p=0.2)
                ...
                vs.plot_func_surface(field_cood=S_order, Ct_id=0,plot_index=1,view_elev=view_elev+elev_chage, view_azim=view_azim,title='Nematic on Sphere: Top',color_range=[0,1],set_range=True,bg_off=True,cbar=False,alpha_c=0.3,marker_size=marker_sizea)
               ...
               # vs.plot_wnt_range(plot_index=1,z0=z0,alpha=alpha,R=R,title='Wnt Strength: '+str(wnt_strength),color='red',view_elev=view_elev+elev_chage, view_azim=view_azim,sub_fig=False,alpha_p=0.9)
                ...
                vs.plot_func_surface(field_cood=S_order, Ct_id=0,plot_index=1,view_elev=view_elev-elev_chage, view_azim=view_azim,title='Nematic on Sphere: Bot',color_range=[0,1],set_range=True,bg_off=True,cbar=False,alpha_c=0.3,marker_size=marker_sizea)
               ...
               # vs.plot_wnt_range(plot_index=1,z0=z0,alpha=alpha,R=R,title='Wnt Strength: '+str(wnt_strength),color='red',view_elev=view_elev, view_azim=view_azim+azim_change,sub_fig=False,alpha_p=0.9)
                #vs.plot_quiver(_director=Dir_profile,Ct_id=2,plot_index=1,plot_density=1,title='Nematic on Sphere: Front',view_elev=view_elev, view_azim=view_azim+azim_change,color='black',vector_length=0.07*R,vector_width=1.5)
                vs.plot_func_surface(field_cood=S_order, Ct_id=0,plot_index=1,view_elev=view_elev, view_azim=view_azim+0.5*azim_change,title='Nematic on Sphere: Front',color_range=[0,1],set_range=True,bg_off=True,cbar=False,alpha_c=0.3,marker_size=marker_sizea)
              ...
              #  vs.plot_wnt_range(plot_index=1,z0=z0,alpha=alpha,R=R,title='Wnt Strength: '+str(wnt_strength),color='red',view_elev=view_elev, view_azim=view_azim+azim_change,sub_fig=False,alpha_p=0.2)
               ...
               # vs.plot_wnt_range(plot_index=1,z0=z0,alpha=alpha,R=R,title='Wnt Strength: '+str(wnt_strength),color='red',view_elev=view_elev, view_azim=view_azim+azim_change,sub_fig=False,alpha_p=0.9)
                #vs.plot_quiver(_director=Dir_profile,Ct_id=2,plot_index=1,plot_density=1,title='Nematic on Sphere: Front',view_elev=view_elev, view_azim=view_azim+azim_change,color='black',vector_length=0.07*R,vector_width=1.5)
                vs.plot_func_surface(field_cood=S_order, Ct_id=0,plot_index=1,view_elev=view_elev, view_azim=view_azim+1.5*azim_change,title='Nematic on Sphere: Front',color_range=[0,1],set_range=True,bg_off=True,cbar=False,alpha_c=0.3,marker_size=marker_sizea)
              ...
              #  vs.plot_wnt_range(plot_index=1,z0=z0,alpha=alpha,R=R,title='Wnt Strength: '+str(wnt_strength),color='red',view_elev=view_elev, view_azim=view_azim+azim_change,sub_fig=False,alpha_p=0.2)
                ...
                vs.plot_func_surface(field_cood=s_val, Ct_id=1,plot_index=1,view_elev=view_elev, view_azim=view_azim,title='Nematic on Sphere: Bot',color_range=[0,1],set_range=True,bg_off=True,cbar=False,alpha_c=0.3,marker_size=marker_sizea)
                ...
                vs=Visualization(mesh_cood,mesh_loc,Dir_mesh,R=R,row_num=1,column_num=1,w=10,h=10)
               # vs.plot_quiver(_director=Dir_profile,Ct_id=2,plot_index=1,plot_density=1,title='Nematic on Sphere: Bot',view_elev=view_elev, view_azim=view_azim+45,color='black',vector_length=len_size*R,vector_width=1.5)
                vs.plot_func_surface(field_cood=concentration_fuc, Ct_id=0,plot_index=1,view_elev=view_elev, view_azim=view_azim,title='Nematic on Sphere: Bot',color_range=[np.min(concentration_fuc),1.4*np.max(concentration_fuc)],set_range=True,bg_off=True,cbar=False,alpha_c=0.3,marker_size=marker_sizea,cmap='GnBu')
                ...
                vs.plot_func_surface(field_cood=concentration_fuc, Ct_id=0,plot_index=1,view_elev=view_elev+60, view_azim=view_azim+45,title='Gaussian Concentration Strength: '+str(wnt_strength),color_range=[np.min(concentration_fuc),1.4*np.max(concentration_fuc)],set_range=False,bg_off=True,cbar=False,alpha_c=0.4,marker_size=marker_sizea)
               ...
               # vs.plot_func_surface(field_cood=s_val, Ct_id=1,plot_index=1,view_elev=view_elev+10, view_azim=view_azim+45,title='Concentration Field Strength: '+str(wnt_strength),color_range=[0,1],set_range=True,cbar=False,alpha_c=0.4,bg_off=False)
                ...
                vs.plot_func_surface(field_cood=s_val, Ct_id=1,plot_index=1,view_elev=0, view_azim=view_azim+45,title='Concentration Field Strength: '+str(wnt_strength),color_range=[0,1],set_range=True,cbar=False,alpha_c=0.3,bg_off=False,marker_size=marker_sizea)
                ...
                check_val=Func_space.defect_check(Defect_relative_info[plot_index,:],Defect_relative_info[plot_index-1,:],target=0.0001)
                print('array_cha')
                print(cha_arry)

                vs.export_csv(array_i=cha_arry,header_name='aspect_ratio:'+str(alpha),file_name=file_loc+'/aspect_ratio'+str(alpha)+'.csv')
                if check_val==True:
                ...
                if condition_check==condition_check_density:
                    vs.save_fig(file_loc,plot_index, 500,name='Strength_'+str(round(wnt_strength,2))+'_range_'+str(round(z0,2)))
                else:
                    pass
